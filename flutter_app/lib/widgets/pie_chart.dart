...
class _PiechartComponentState extends State<PiechartComponent> {
  ...
  double entertainmentExpenses =
      totalForSpecificTransaction('Entertainment').toDouble();
  double grocceryExpenses = totalForSpecificTransaction('Groccery').toDouble();
  double otherExpenses = totalForSpecificTransaction('Other').toDouble();
                    ...
                    child: Column(
                      children: [
                        ...
                        Row(
                          mainAxisAlignment: MainAxisAlignment.start,
                          children: [
                            _buildColorIcon(Colors.indigo),
                            SizedBox(width: 8),
                            Text(
                              'Entertainment: Rs ${entertainmentExpenses}',
                              style: TextStyle(
                                color: Colors.grey[300],
                                fontSize: 18,
                                fontWeight: FontWeight.w600,
                        ...
                        Row(
                          mainAxisAlignment: MainAxisAlignment.start,
                          children: [
                            _buildColorIcon(Colors.lime),
                            SizedBox(width: 8),
                            Text(
                              'Groccery: Rs ${grocceryExpenses}',
                              style: TextStyle(
                                color: Colors.grey[300],
                                fontSize: 18,
                                fontWeight: FontWeight.w600,
                        ...
                        Row(
                          mainAxisAlignment: MainAxisAlignment.start,
                          children: [
                            _buildColorIcon(Colors.blueGrey),
                            SizedBox(width: 8),
                            Text(
                              'Other: Rs ${otherExpenses}',
                              style: TextStyle(
                                color: Colors.grey[300],
                                fontSize: 18,
                                fontWeight: FontWeight.w600,
